...
class App {
    ...
    _newWorkout(e) {
        ...
        if (type === 'running') {
            ...
            if (!validInputs(distance, duration, cadence) || !allPositive(distance, duration, cadence)) return alert('Distane should be a positive number');
            workout = new Running([
                lat,
                lng
        ...
        if (type === 'cycling') {
            ...
            if (!validInputs(distance, duration, elevation) || !allPositive(distance, duration)) return alert('Inputs have to a positive number');
            workout = new Cycling([
                lat,
                lng
    ...
    <div class="workout__details">
      ...
      <><span class="workout__value">${workout1.distance}</span><span class="workout__unit">km</span></>
    </div>
    <div class="workout__details">
    ...
    <div class="workout__details">
            <><span class="workout__icon">⚡️</span><span class="workout__value">${workout1.pace.toFixed(1)}</span><span class="workout__unit">min/km</span></>
          </div>
          <div class="workout__details">
            <span class="workout__icon">🦶🏼</span>
        ...
        <div class="workout__details">
        <><span class="workout__icon">⚡️</span><span class="workout__value">${workout1.speed.toFixed(1)}</span><span class="workout__unit">km/h</span></>
      </div>
      <div class="workout__details">
        <span class="workout__icon">⛰</span>
